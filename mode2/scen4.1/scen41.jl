...
function CarSim(params::SimParams, models::Dict{Int, DriverModel})
    ...
    cars = [Vehicle(VehicleState(VecSE2(-35.0,0,0), roadway.segments[1].lanes[1],roadway, 11.17),
             ...
             PEDESTRIAN_DEF, 3),Vehicle(VehicleState(VecSE2(0.5,5.0,-π/2), env.crosswalk, cw_roadway, 1.4),
             PEDESTRIAN_DEF, 4),Vehicle(VehicleState(VecSE2(-0.5,5.0,-π/2), env.crosswalk, cw_roadway, 1.4),
             PEDESTRIAN_DEF, 5)]
    car1 = cars[1]
    car2 = cars[2]
    car3 = cars[3]
